...
| v18          | PRODOTTO - INVENTARIO - SCARICO - scarta - di_tipo  - acquista - APPUNTAMENTO | La quantità di un prodotto p in inventario deve essere il numero di unità (in prodotto) in relazione di_tipo con p e non acquistai e non scartati | check        | SI           |
...
| V21          | TURNO                                                        | INon ci possono essere turni con lo stesso dataOra (dataOra  è unique) | unique       | SI           |
